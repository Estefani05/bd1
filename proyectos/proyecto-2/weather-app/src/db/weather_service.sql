...
--
-- Current Database: `weather_service`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `weather_service` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `forecast` (
  ...
  PRIMARY KEY (`id`),
  KEY `city_id` (`city_id`),
  CONSTRAINT `forecast_ibfk_1` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-11-18 10:51:40

CREATE USER 'weatherappuser'@'localhost' IDENTIFIED BY 'weatherapppass';
GRANT SELECT, INSERT, UPDATE ON weather_service.* TO 'weatherappuser'@'localhost';
