...
public class CountryRepository implements Repository<Country, Integer> {
    ...
    public Optional<Country> findById(Integer countryId) {
        try (Connection connection = this.dataSource.getConnection();
             CallableStatement stmt = connection.prepareCall(Queries.FIND_ALL_ObtenerPaises_PROC)) {
    ...
    public List<Country> findAll() {
        ...
        try (Connection connection = this.dataSource.getConnection();
             CallableStatement stmt = connection.prepareCall(Queries.FIND_ONE_BuscarPais_PROC)) {
    ...
    public Country save(Country country) {
        try (Connection connection = this.dataSource.getConnection();
             CallableStatement stmt = connection.prepareCall(Queries.INSERT_InsertarPais_PROC)) {
    ...
    public void delete(Integer countryId) {
        try (Connection connection = this.dataSource.getConnection();
             CallableStatement stmt = connection.prepareCall(Queries.DELETE_EliminarPais_PROC)) {
    ...
    public Country update(Country country) {
        ...
        try (Connection connection = this.dataSource.getConnection();
             CallableStatement stmt = connection.prepareCall(Queries.UPDATE_ActualizarPais_PROC)) {
